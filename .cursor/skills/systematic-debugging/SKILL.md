...
description: >-
  Structured debugging methodology — reproduce, isolate, hypothesize, verify. Covers git bisect, binary search, logging, and minimal reproduction. Use when the user asks for systematic debugging.
